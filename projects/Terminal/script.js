...
function displayResult(command) {
    ...
    switch (command) {
        ...
        case "resume":
            ...
            break;
        case "linkedin":
            text = "You can view my LinkedIn profile on the following link: https://www.linkedin.com/in/shivi-agarwal-02018b228 or I can open it for you.......";
